    ...
    <?php elseif ($view === 'promotions'): ?>
        <div class="pricing-promotions" style="background: radial-gradient(circle at 10% 20%, #1b2a4a, #0b1220); padding: 20px; border-radius: 14px; border: 1px solid rgba(255,255,255,0.08);">
            <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap: wrap; margin-bottom: 16px; color: #e2e8f0;">
                ...
                <div>
                    <a href="#" class="btn btn-primary" onclick="showPromotionForm()" style="background: #a1a1aa; color: white; padding: 10px 16px; border-radius: 8px; text-decoration: none; font-weight: 600;">+ Nova Promoção</a>
                </div>
            </div>
            ...
            <table class="table" style="width: 100%; border-collapse: collapse; background: #0f172a; color: #e2e8f0; border: 1px solid #1e293b;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #1e293b;">
                        ...
                        <td style="padding: 12px 16px; text-align: center;">
                            <a href="#" class="btn-small" style="background: #a1a1aa; color: white; padding: 6px 12px; border-radius: 4px; text-decoration: none; font-size: 12px;">Editar</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            ...
            <table class="table" style="width: 100%; border-collapse: collapse; background: #0f172a; color: #e2e8f0; border: 1px solid #1e293b;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #1e293b;">
                        ...
                        <td style="padding: 12px 16px; text-align: center;">
                            <a href="#" class="btn-small" style="background: #a1a1aa; color: white; padding: 6px 12px; border-radius: 4px; text-decoration: none; font-size: 12px;" onclick="editCategoryRule('<?php echo $rule['category']; ?>')">Editar</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
